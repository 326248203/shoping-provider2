    ...
    <div class="w" id="header-2013">
        ...
        <div id="search-2013">
            <div class="i-search ld">
                ...
                <form id="actionForm" action="<%=request.getContextPath()%>/goods/list.do" method="POST">
                    <div class="form">
                        ...
                        <div class="lh-wrap">
                            <div class="p-img">
                                <a target="_blank" href="#">
                                    <img width="220" height="282" class="err-product" src="<%=request.getContextPath()%>/images/${item.picture}">
                                </a>
                            </div>
                            <div class="p-name">
