...
/******/ ([
    ...
    /***/ function(module, exports, __webpack_require__) {
        ...
        var _getShopOwner = function (shopId, callback) {
            return $.ajax({
                url: 'http://webim.meilishuo.com/jsonp/getshopowner/1', // 涓嶆敮鎸乭ttps
                data: {
                    shopId: shopId
                },
                type: 'GET',
        ...
        var _showIm = function(userId, goodsId) {
            // 璇锋眰瑙﹀彂鏄槻姝竴涓〉闈㈡湁澶氫釜涓嶅悓鐨勫敜閱抜m閫昏緫
            ...
            if(!userId && shopId) {
                ...
                _getShopOwner(shopId, function(resp){
                    if (resp.success && resp.data) {
                        ...
                        shopInfo[shopId] = userId; // 闃叉涓€涓〉闈㈠娆¤姹�
                        _showIm(userId, goodsId);
                    }
                });
                return;
    ...
    /***/ function(module, exports) {
        ...
        $.fn.drag = function(data){
            ...
            var handler= opts.handler; //鎷栧姩鐨勫璞�
